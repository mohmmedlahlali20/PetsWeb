...
<html lang="en">
    <head>
            ...
            <!-- favicon -->
            <link rel="icon" href="/public/images/fb-icon.png" type="image/gif" />
   ...
   <body class="container">
      ...
      <div class="header_section header_bg ">
         <nav class="navbar navbar-expand-lg navbar-light bg-green">
            <a href="{{ route('welcome') }}" class="logo"><img width="15%" class="mb-0" src="{{ asset('images/logo.jpg') }}"></a>
                     ...
                     <div class="container">
                        <div class="row">
                           <div class="col-md-7">
                              ...
                              <div class="image_1"><img src="{{ asset('images/pets4.png') }}"></div>
                           </div>
                           <div class="col-md-5">
                  ...
                  <div class="carousel-item">
                     <div class="container">
                        <div class="row">
                           <div class="col-md-7">
                              <div class="best_text">Best</div>
                              <div class="image_1"><img src="{{ asset('images/cats.png') }}"></div>
                           </div>
                           <div class="col-md-5">
                              <h1 class="banner_taital">New Model Cycle</h1>
                              <p class="banner_text">It is a long established fact that a reader will be distracted by the readable content </p>
                  ...
                  <div class="carousel-item">
                     <div class="container">
                        <div class="row">
                           <div class="col-md-7">
                              <div class="best_text">Best</div>
                              <div class="image_1"><img src="{{ asset('images/bird.png') }}"></div>
                           </div>
                           <div class="col-md-5">
                              <h1 class="banner_taital">New Model Cycle</h1>
                              <p class="banner_text">It is a long established fact that a reader will be distracted by the readable content </p>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="box_main">
                        ...
                        <div class="image_2"><img src="{{ asset('images/cat1.jpg') }}"></div>
                     </div>
                  </div>
                  <div class="col-md-6">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="box_main_3">
                        ...
                        <div class="image_2"><img src="{{ asset('images/pets3.jpg') }}"></div>
                     </div>
                  </div>
               </div>
            </div>
